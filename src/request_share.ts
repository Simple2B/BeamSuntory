...
// search flow
const searchShareInput: HTMLInputElement = document.querySelector(
  '#table-search-request-shares',
);
const searchShareInputButton = document.querySelector(
  '#table-search-request-share-button',
);
