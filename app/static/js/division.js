...
var editDivisionCloseModalButton = document.querySelector('#edit-division-modal-close-btn');
editDivisionCloseModalButton.addEventListener('click', function () {
    modal.hide();
});
