...
var $modalElement = document.querySelector('#editDivisionModal');
var modalOptions = {
...
var $buttonElements = document.querySelectorAll('.division-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-divisions');
var searchInputButton = document.querySelector('#table-search-division-button');
...
var deleteButtons = document.querySelectorAll('.delete-division-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-division-id');
                    return [4 /*yield*/, fetch("/division/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editDivision(division) {
    var input = document.querySelector('#division-edit-role-name');
    ...
    var select = document.querySelector('#division-edit-parent-role');
    division.possible_parent_roles.forEach(function (optionValue) {
