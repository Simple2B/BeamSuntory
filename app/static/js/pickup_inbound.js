...
var $modalElement = document.querySelector('#editPickupInboundModal');
var modalOptions = {
    ...
    closable: true,
    onHide: function () {
        var pickupInboundItems = document.querySelectorAll('.pickup-inbound-edit-add-item');
        pickupInboundItems.forEach(function (item) {
            item.remove();
        });
...
var $buttonElements = document.querySelectorAll('.pickup-inbound-edit-button');
...
function editPickupInbound(inboundOrder) {
    console.log('inboundOrder:', inboundOrder);
    var input = document.querySelector('#pickup-inbound-edit-id');
...
function setProducts() {
    var pickupInboundProducts = document.querySelectorAll('.pickup-inbound-product-item');
    var pickupInboundProductsQuantity = document.querySelectorAll('.pickup-inbound-edit-recieved-quantity');
    var products = [];
    for (var i = 0; i < pickupInboundProducts.length; i++) {
        var pickupInboundProduct = pickupInboundProducts[i];
        var pickupInboundQuantity = pickupInboundProductsQuantity[i];
        var productId = pickupInboundProduct.getAttribute('data-target-product-id');
        var product = {
    ...
    var inputRecievedProducts = document.querySelector('#pickup-inbound-edit-recieved-products');
    inputRecievedProducts.value = JSON.stringify(products);
}
// ----submit form through hidden submit button----
var inboundOrderSubmitButton = document.querySelector('#pickup-inbound-submit-btn');
var inboundOrderSaveProductsButton = document.querySelector('#pickup-inbound-save-products-btn');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch("/pickup_inbound/pickup/".concat(inboundOrder.id), {
                        method: 'GET',
                    })];
            case 1:
                response = _a.sent();
...
viewPickupInboundButtons.forEach(function (e) {
    return e.addEventListener('click', function () {
        ...
        var div = document.querySelector('#pickup-inbound-view-quantity-wrap');
