...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var orderSupplierView = document.querySelector('#pickup-inbound-view-supplier-id');
    ...
    pickupInboundButton.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        var orderId, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    orderId = pickupInboundButton.getAttribute('data-target');
                    if (!confirm('Are sure?')) return [3 /*break*/, 2];
                    return [4 /*yield*/, fetch("/pickup_inbound/pickup/".concat(orderId), {
                            method: 'PUT',
                        })];
                case 1:
                    response = _a.sent();
