...
// ----view modal----
var $viewModalElement = document.querySelector('#viewPickupInboundModal');
var viewModalOptions = {
    ...
    closable: true,
    onHide: function () {
        var productItems = document.querySelectorAll('.pickup-inbound-view-add-item');
...
var viewPickupInboundButtons = document.querySelectorAll('.pickup-inbound-view-button');
viewPickupInboundButtons.forEach(function (e) {
    return e.addEventListener('click', function () {
        var inboundOrder = JSON.parse(e.getAttribute('data-target'));
        viewPickupInbound(inboundOrder);
    });
});
function viewPickupInbound(inboundOrder) {
    var packageInfo = inboundOrder.package_info;
    var div = document.querySelector('#pickup-inbound-view-order-id');
...
function createViewPickupInboundOrderItems(inbOrder, curInbOrder) {
    ...
    var inboundOrderAddContainer = document.querySelector('#pickup-inbound-view-add-container');
    ...
    var inboundOrderAddProduct = inboundOrderAddItem.querySelector('.pickup-inbound-view-add-product');
    var inboundOrderAddSKU = inboundOrderAddItem.querySelector('.pickup-inbound-view-add-SKU');
    var inboundOrderAddGroup = inboundOrderAddItem.querySelector('.pickup-inbound-view-add-group');
    var inboundOrderAddQuantity = inboundOrderAddItem.querySelector('.pickup-inbound-view-add-quantity');
