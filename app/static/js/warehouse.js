...
var $modalElement = document.querySelector('#editWarehouseModal');
var $addWarehouseModalElement = document.querySelector('#add-warehouse-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addWarehouseModalElement, modalOptions);
var $buttonElements = document.querySelectorAll('.warehouse-edit-button');
$buttonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        editWarehouse(JSON.parse(e.getAttribute('data-target')));
    });
});
var closingEditModalButton = document.getElementById('edit-warehouse-modal-close-btn');
...
// search flow
var searchInput = document.querySelector('#table-search-warehouses');
var searchInputButton = document.querySelector('#table-search-warehouse-button');
...
var deleteButtons = document.querySelectorAll('.delete-warehouse-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-warehouse-id');
                    return [4 /*yield*/, fetch("/warehouse/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editWarehouse(warehouse) {
    ...
    var input = document.querySelector('#warehouse-edit-name');
