...
var $modalElement = document.querySelector('#editSupplierModal');
var $addSupplierModalElement = document.querySelector('#add-supplier-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addSupplierModalElement, modalOptions);
var closingEditModalButton = document.getElementById('edit-suppler-modal-close-btn');
closingEditModalButton.addEventListener('click', function () {
    modal.hide();
});
var $buttonElements = document.querySelectorAll('.supplier-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-suppliers');
var searchInputButton = document.querySelector('#table-search-supplier-button');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-supplier-id');
                    return [4 /*yield*/, fetch("/supplier/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editSupplier(supplier) {
    var input = document.querySelector('#supplier-edit-name');
