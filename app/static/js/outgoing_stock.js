...
function createOutgoingStockItemTable(shipRqst, typeModal) {
    ...
    var currentCartItems = shipRqst.current_order_carts;
    currentCartItems.forEach(function (product, index) {
        ...
        tableShipRequestItem.innerHTML = "\n        <td class=\"w-4 p-4\">\n          <div class=\"flex items-center\">\n            ".concat(index + 1, "\n          </div>\n        </td>\n        <td scope=\"row\" class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            ").concat(product.image.length > 100
            ? "<img src=\"data:image/png;base64, ".concat(product.image, "\" alt=\"").concat(product.name, "\" class=\"w-14 h-14\">")
            : "<img src=\"/static/img/default_image_brand.png\" alt=\"".concat(product.name, "\" class=\"w-14 h-14\">"), "\n          </div>\n        </td>\n        <td scope=\"row\" class=\"max-w-xs p-4 text-base font-normal text-gray-900 dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-product-name text-base font-semibold\" data-target-product-id=\"").concat(product.id, "\">").concat(product.name, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"text-base font-semibold\">").concat(product.SKU, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"text-base font-semibold\">some date</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-retail-regular_price text-base font-semibold\">").concat(product.regular_price, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-retail-retail_price text-base font-semibold\">").concat(product.retail_price, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-group text-base font-semibold\">").concat(product.group, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-quantity text-base font-semibold\">").concat(product.quantity, "</div>\n        </div>\n        </td>\n      ");
        ...
        var warehouseName = product.warehouse ? product.warehouse.name : 'No Warehouse';
        ...
        if (typeModal === 'edit') {
            ...
            var selectWarehouse = tableShipRequestItem.querySelector("#outgoing-stock-".concat(typeModal, "-warehouse-name"));
            for (var _i = 0, _a = shipRqst.warehouses; _i < _a.length; _i++) {
                var warehouse = _a[_i];
...
function setWarehouseAllItems(warehouseId, typeModal) {
    ...
    warehousesSelect.forEach(function (e) {
...
isWarehouseSetAll.addEventListener('change', function () {
    if (isWarehouseSetAll.checked) {
        ...
        var warehouseId = warehouseInput.value;
