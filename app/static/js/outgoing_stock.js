...
// search flow
var searchOutgoingInput = document.querySelector('#table-search-outgoing-stock');
...
var updateNotesButtons = document.querySelectorAll('.outgoing-stock-edit-notes-btn');
updateNotesButtons.forEach(function (e) {
    e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        var shipRequestId, wmNotes, csrfTokenInput, data, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    shipRequestId = document.querySelector('#outgoing-stock-edit-id').getAttribute('value');
                    wmNotes = document.querySelector('#outgoing-stock-edit-wm_notes');
                    csrfTokenInput = document.querySelector('#csrf_token');
                    data = {
                        csrf_token: csrfTokenInput.value,
                        wm_notes: wmNotes.value,
                        ship_request_id: shipRequestId,
                    };
                    return [4 /*yield*/, fetch("/outgoing_stock/update_notes", {
                            method: 'POST',
                            headers: {
...
var $modalViewElement = document.querySelector('#view-outgoing-stock-modal');
var $modalEditElement = document.querySelector('#edit-outgoing-stock-modal');
var editModalClosingButton = document.querySelector('#buttonClosingEditOutgoingStockModal');
var viewModalClosingButton = document.querySelector('#buttonClosingEditOutgoingStockModal');
editModalClosingButton.addEventListener('click', function () {
    editModal.hide();
});
viewModalClosingButton.addEventListener('click', function () {
    viewModal.hide();
});
var modalViewOptions = {
    ...
    onHide: function () {
        ...
        var tableShipRequestBody = document.querySelector('#table-outgoing-stock-body-view');
...
var modalEditOptions = {
    ...
    onHide: function () {
        console.log('modal is hidden');
        var tableShipRequestBody = document.querySelector('#table-outgoing-stock-body-edit');
        while (tableShipRequestBody.firstChild) {
            tableShipRequestBody.removeChild(tableShipRequestBody.firstChild);
        }
    },
...
var viewModal = new flowbite_1.Modal($modalViewElement, modalViewOptions);
var editModal = new flowbite_1.Modal($modalEditElement, modalEditOptions);
// ----view modal-----
var viewOutgoingStockButtonElements = document.querySelectorAll('.outgoing-stock-view-button');
viewOutgoingStockButtonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        var shipRequest = JSON.parse(e.getAttribute('data-target'));
        console.log('shipRequest: ', shipRequest);
        var div = document.querySelector('#outgoing-stock-view-order-number');
        ...
        var input = document.querySelector('#outgoing-stock-view-id');
...
// -----edit modal------
var $buttonEditElements = document.querySelectorAll('.outgoing-stock-edit-button');
$buttonEditElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        editShipRequest(JSON.parse(e.getAttribute('data-target')), JSON.parse(e.getAttribute('data-target-store')));
    });
});
function editShipRequest(shipRequest, store) {
    var input = document.querySelector('#outgoing-stock-edit-status');
    ...
    var div = document.querySelector('#outgoing-stock-edit-order-number');
    div.innerHTML = shipRequest.orderNumb;
...
function createOutgoingStockItemTable(shipRqst, typeModal) {
    var warehousesJSONInput = document.getElementById('warehouses-json-input');
    var warehousesEventsJSONInput = document.getElementById('warehouses-events-json-input');
    var warehouses = JSON.parse(warehousesJSONInput.value);
    var warehousesEvents = JSON.parse(warehousesEventsJSONInput.value);
    var tableShipRequestBody = document.querySelector("#table-outgoing-stock-body-".concat(typeModal));
    shipRqst.carts.forEach(function (cart, index) {
        var tableShipRequestItem = document.createElement('tr');
        tableShipRequestItem.classList.add('table-product-item-tr', 'bg-white', 'border-b', 'dark:bg-gray-800', 'dark:border-gray-700', 'hover:bg-gray-50', 'dark:hover:bg-gray-600');
        tableShipRequestItem.innerHTML = "\n        <td class=\"w-4 p-4\">\n          <div class=\"flex items-center\">\n            ".concat(index + 1, "\n          </div>\n        </td>\n        <td scope=\"row\" class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            ").concat(cart.product.image.length > 100
            ? "<img src=\"data:image/png;base64, ".concat(cart.product.image, "\" alt=\"").concat(cart.product.name, "\" class=\"w-14 h-14\">")
            : "<img src=\"/static/img/default_image_brand.png\" alt=\"".concat(cart.product.name, "\" class=\"w-14 h-14\">"), "\n          </div>\n        </td>\n        <td scope=\"row\" class=\"max-w-xs p-4 text-base font-normal text-gray-900 dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-product-name text-base font-semibold\" data-target-product-id=\"").concat(cart.product.id, "\">").concat(cart.product.name, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"text-base font-semibold\">").concat(cart.product.SKU, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"text-base font-semibold\">some date</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-retail-regular_price text-base font-semibold\">").concat(cart.product.regularPrice, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-retail-retail_price text-base font-semibold\">").concat(cart.product.regularPrice, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-start-date text-base font-semibold\">").concat(cart.event ? cart.event.dateFrom : '-', "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-end-date text-base font-semibold\">").concat(cart.event ? cart.event.dateTo : '-', "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-location-notes text-base font-semibold\">").concat(cart.product.notes_location ? cart.product.notes_location : '-', "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-group text-base font-semibold\">").concat(cart.group, "</div>\n          </div>\n        </td>\n        <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n          <div class=\"pl-3\">\n            <div class=\"cart-item-quantity text-base font-semibold\">").concat(cart.quantity, "</div>\n        </div>\n        </td>\n      ");
        var warehouseEditElement = document.createElement('td');
        warehouseEditElement.classList.add('p-4', 'space-x-2', 'whitespace-nowrap');
        // Select warehouse
        warehouseEditElement.innerHTML = "\n      <td class=\"p-4 space-x-2 whitespace-nowrap\">\n            <select type=\"text\" name=\"store\" id=\"outgoing-stock-".concat(typeModal, "-warehouse-name\"\n              class=\"outgoing-stock-").concat(typeModal, "-warehouse-name shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500\"\n              required>\n                <option selected=\"selected\" value=\"\" disabled>Select Warehouse</option>\n            </select>\n      </td>\n    ");
        var warehouseName = cart.warehouse ? cart.warehouse.name : 'No Warehouse';
        var warehouseViewElement = document.createElement('td');
        warehouseViewElement.classList.add('p-4', 'space-x-2', 'whitespace-nowrap');
        warehouseViewElement.innerHTML = "\n      <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n        <div class=\"pl-3\">\n          <div class=\"text-base text-gray-900 dark:text-white font-semibold\">".concat(warehouseName, "</div>\n        </div>\n      </td>\n    ");
        if (typeModal === 'edit') {
            tableShipRequestItem.appendChild(warehouseEditElement);
            var selectWarehouse_1 = tableShipRequestItem.querySelector("#outgoing-stock-".concat(typeModal, "-warehouse-name"));
            var includeWarehouses_1;
            if (cart.group === EventsGroup) {
                includeWarehouses_1 = warehousesEvents;
            }
            else {
                includeWarehouses_1 = warehouses;
            }
            cart.product.warehouses.forEach(function (productWarehouse) {
                if (includeWarehouses_1.some(function (warehouse) { return warehouse.name == productWarehouse.name; })) {
                    var option = document.createElement('option');
                    option.value = productWarehouse.id.toString();
                    option.text = productWarehouse.name;
                    selectWarehouse_1.appendChild(option);
                }
            });
            if (selectWarehouse_1.options.length === 2) {
                selectWarehouse_1.options[1].selected = true;
            }
            if (cart.product.warehouse) {
                selectWarehouse_1.value = cart.product.warehouse.id.toString();
            }
            if (shipRqst.status !== 'Waiting for warehouse manager') {
                var allWarehousesSelect = document.querySelector('#outgoing-stock-edit-warehouse-name');
                var allWarehousesCheckbox = document.querySelector('#outgoing-stock-edit-warehouse-set-all');
                allWarehousesSelect.disabled = true;
                selectWarehouse_1.disabled = true;
...
function setWarehouseAllItems(warehouseId, typeModal) {
    var warehousesSelect = document.querySelectorAll(".outgoing-stock-".concat(typeModal, "-warehouse-name"));
    var warehousesJSONInput = document.getElementById('warehouses-json-input');
    var warehouses = JSON.parse(warehousesJSONInput.value);
    if (warehouses.some(function (warehouse) { return warehouse.id === warehouseId; })) {
        // Non event warehouse
        warehousesSelect.forEach(function (select) {
...
var isWarehouseSetAll = document.querySelector('#outgoing-stock-edit-warehouse-set-all');
isWarehouseSetAll.addEventListener('change', function () {
    if (isWarehouseSetAll.checked) {
        var warehouseInput = document.querySelector('#outgoing-stock-edit-warehouse-name');
        var warehouseId = parseInt(warehouseInput.value);
        setWarehouseAllItems(warehouseId, 'edit');
    }
});
var warehouseNameSelect = document.querySelector('#outgoing-stock-edit-warehouse-name');
warehouseNameSelect.addEventListener('change', function () {
...
function setProducts() {
    var outgoingStockGroupItems = document.querySelectorAll('.cart-item-group');
    var outgoingStockProductItem = document.querySelectorAll('.cart-item-product-name');
    var outgoingStockQuantityItems = document.querySelectorAll('.cart-item-quantity');
    var outgoingStockWarehouses = document.querySelectorAll('.outgoing-stock-edit-warehouse-name');
    var products = [];
    for (var i = 0; i < outgoingStockProductItem.length; i++) {
        var outgoingStockProductNameItem = outgoingStockProductItem[i];
        var inboundOrderAddQuantity = outgoingStockQuantityItems[i];
        var outgoingStockGroupName = outgoingStockGroupItems[i];
        var outgoingStockWarehouse = outgoingStockWarehouses[i];
        var product = {
    ...
    var inputProducts = document.querySelector('#outgoing-stock-edit-products');
    inputProducts.value = JSON.stringify(products);
    return true;
}
// ----submit edit form through hidden submit button----
var inboundOrderSubmitButton = document.querySelector('#outgoing-stock-submit-btn');
var inboundOrderSaveProductsButton = document.querySelector('#outgoing-stock-save-products-btn');
