...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var tableRow = document.querySelectorAll('.table-sku-item-tr');
    tableRow.forEach(function (row) {
        var viewReportInventoriesModal = row.querySelector('.report-sku-view-btn');
        var data = JSON.parse(viewReportInventoriesModal.getAttribute('data-target'));
        var reportStore = data.shipRequest.store.storeName;
        var reportSKUStoreDiv = row.querySelector('.report-sku-store');
    ...
    var closingViewModalButton = document.querySelector('#button-closing-report-sku-modal');
    closingViewModalButton.addEventListener('click', function () {
        viewModal.hide();
    });
    // view buttons click
    var reportViewUser = document.getElementById('report-sku-user');
    var reportViewAction = document.getElementById('report-sku-action');
    var reportViewDate = document.getElementById('report-sku-date');
    ...
    htmxDispatcher.onLoad('inventories-table', function (target) {
        var reportViewButtons = target.querySelectorAll('.report-sku-view-btn');
        reportViewButtons.forEach(function (btn) {
            btn.addEventListener('click', function () {
                var reportSKU = JSON.parse(btn.getAttribute('data-target'));
                ...
                reportSKU.reportInventories.forEach(function (sku, i) {
                    // Render sku
                    ...
                    sku.product.image.length > 100
                        ? (img.src = "data:image/png;base64, ".concat(sku.product.image))
                    ...
                    sku.product.warehouseProducts.forEach(function (warehouseProduct) {
