...
var $modalElement = document.querySelector('#editMasterGroupModal');
var $addMasterGroupModalElement = document.querySelector('#add-master-group-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addMasterGroupModalElement, modalOptions);
var editMasterGroupCloseModalButton = document.querySelector('#edit-master-group-modal-close-btn');
editMasterGroupCloseModalButton.addEventListener('click', function () {
    modal.hide();
});
var $buttonElements = document.querySelectorAll('.master-group-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-master-groups');
var searchInputButton = document.querySelector('#table-search-master-group-button');
...
var deleteButtons = document.querySelectorAll('.delete-master-group-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-master-group-id');
                    return [4 /*yield*/, fetch("/master_group/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editMasterGroup(master_group) {
    var input = document.querySelector('#master-group-edit-name');
