...
document.addEventListener('DOMContentLoaded', function () {
    var buttonLoadEventsTable = document.querySelector('#table-ship-request-loader');
    // load table
    ...
    var modalCloserButton = document.querySelector('#button-close-view-ship-request-modal');
    modalCloserButton.addEventListener('click', function () {
        viewModal.hide();
    });
    // view divs
    var orderTitleId = document.getElementById('ship-request-view-order-number');
    var orderType = document.getElementById('ship-request-view-type');
    var orderStatus = document.getElementById('ship-request-view-status');
    var orderCreatedDate = document.getElementById('ship-request-view-created-date');
    var orderWarehouseName = document.getElementById('ship-request-view-warehouse-name');
    var orderComment = document.getElementById('ship-request-view-comment');
    var orderStore = document.getElementById('ship-request-view-store');
    var orderStoreAddress = document.getElementById('ship-request-view-store_address');
    var orderStorePhone = document.getElementById('ship-request-view-store_phone');
    var orderStoreCountry = document.getElementById('ship-request-view-store_country');
    var orderStoreProvince = document.getElementById('ship-request-view-store_province');
    var orderStoreCity = document.getElementById('ship-request-view-store_city');
    var orderStoreZipCode = document.getElementById('ship-request-view-store_zip_code');
    // onload element with events-table id
    htmxDispatcher.onLoad('ship-request-table', function (target) {
        var shipRequestViewButtons = target.querySelectorAll('.ship-request-view-button');
        shipRequestViewButtons.forEach(function (btn) {
            btn.addEventListener('click', function () {
                var shipRequest = JSON.parse(btn.getAttribute('data-target'));
                var store = JSON.parse(btn.getAttribute('data-target-store'));
...
function createShipRequestItemTable(shipRequest, typeModal) {
