...
var $modalViewElement = document.querySelector('#view-ship-request-modal');
var $modalEditElement = document.querySelector('#edit-ship-request-modal');
var modalViewOptions = {
    ...
    onHide: function () {
        ...
        var tableShipRequestBody = document.querySelector('#table-ship-request-body-view');
...
var modalEditOptions = {
    ...
    onHide: function () {
        console.log('modal is hidden');
        var tableShipRequestBody = document.querySelector('#table-ship-request-body-edit');
        while (tableShipRequestBody.firstChild) {
            tableShipRequestBody.removeChild(tableShipRequestBody.firstChild);
        }
    },
...
var $buttonEditElements = document.querySelectorAll('.ship-request-edit-button');
...
function editShipRequest(shipRequest, store) {
    var input = document.querySelector('#ship-request-edit-status');
    ...
    input.value = shipRequest.status;
    var div = document.querySelector('#ship-request-edit-order-number');
    div.innerHTML = shipRequest.order_numb;
...
function createShipRequestItemTable(shipRqst, typeModal) {
    var tableShipRequestBody = document.querySelector("#table-ship-request-body-".concat(typeModal));
    ...
    currentCartItems.forEach(function (product, index) {
        ...
        warehouseEditElement.innerHTML = "\n      <td class=\"p-4 space-x-2 whitespace-nowrap\">\n            <select type=\"text\" name=\"store\" id=\"ship-request-".concat(typeModal, "-warehouse-name\"\n              class=\"ship-request-").concat(typeModal, "-warehouse-name shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500\"\n              required>\n            </select>\n      </td>\n    ");
        var warehouseViewElement = document.createElement('td');
        warehouseViewElement.classList.add('p-4', 'space-x-2', 'whitespace-nowrap');
        warehouseViewElement.innerHTML = "\n      <td class=\"p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white\">\n        <div class=\"pl-3\">\n          <div class=\"text-base text-gray-900 dark:text-white font-semibold\">".concat(shipRqst.warehouse_name, "</div>\n        </div>\n      </td>\n    ");
        if (typeModal === 'edit') {
            tableShipRequestItem.appendChild(warehouseEditElement);
            var selectWarehouse = tableShipRequestItem.querySelector("#ship-request-".concat(typeModal, "-warehouse-name"));
...
function setWarehouseAllItems(warehouseId, typeModal) {
    var warehousesSelect = document.querySelectorAll(".ship-request-".concat(typeModal, "-warehouse-name"));
    warehousesSelect.forEach(function (e) {
        e.value = warehouseId.toString();
    });
}
var isWarehouseSetAll = document.querySelector('#ship-request-edit-warehouse-set-all');
isWarehouseSetAll.addEventListener('change', function () {
    if (isWarehouseSetAll.checked) {
        var warehouseInput = document.querySelector('#ship-request-edit-warehouse-name');
        var warehouseId = warehouseInput.value;
        setWarehouseAllItems(warehouseId, 'edit');
    }
});
var warehouseNameSelect = document.querySelector('#ship-request-edit-warehouse-name');
