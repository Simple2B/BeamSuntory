...
var modalOptions = {
    ...
    onHide: function () {
        ...
        var tableShipRequestBody = document.querySelector('#table-ship-request-body');
...
var viewModal = new flowbite_1.Modal($modalViewElement, modalOptions);
// search flow
...
viewShipRequestButtonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        ...
        var tableShipRequestBody = document.querySelector('#table-ship-request-body');
        var currentCartItems = shipRequest.current_order_carts;
