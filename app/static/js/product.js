...
var productBookingButton = document.querySelector('.product-booking-button');
productBookingButton.addEventListener('click', function () {
    eventModal.show();
    var bookingButton = document.querySelector('.product-booking-button');
    var product = JSON.parse(bookingButton.getAttribute('data-target'));
...
bookingAvaliableQuantity.addEventListener('change', function () {
    validateBookingQuantity();
});
bookingDesiredQuantity.addEventListener('change', function () {
    validateBookingQuantity();
});
var validateBookingQuantity = function () {
    var bookingButton = document.querySelector('#product-event-submit-btn');
