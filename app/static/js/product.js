...
function setProducts() {
    ...
    for (var i = 0; i < productGroupEditItems.length; i++) {
        ...
        var product = {
            group_id: Number(productGroupItems_1.value),
