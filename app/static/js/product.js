...
function createProductGroupEditItem(productParam, masterGroup) {
    ...
    if (masterGroup) {
        ...
        productParam.mstr_grps_grps_names_in_prod[masterGroup].forEach(function (group) {
