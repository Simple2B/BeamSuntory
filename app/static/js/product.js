...
function adjustProduct(productParam, csrfToken) {
    return __awaiter(this, void 0, void 0, function () {
        var adjustNote, productInWarehouses, adjustQuantityInputs, quantities, isAllQuantitiesValid, data, base_url, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    adjustQuantityInputs = document.querySelectorAll('.product-adjust-group-quantity');
                    quantities = [];
                    adjustQuantityInputs.forEach(function (quantityInput) {
                        quantities.push(quantityInput.value);
                    });
                    isAllQuantitiesValid = quantities.every(function (quantity) { return parseInt(quantity) >= 0; });
