                                        ...
                                        switch (_b.label) {
                                            ...
                                            case 1:
                                                ...
                                                fetchedAmountByDate.forEach(function (_a) {
                                                    ...
                                                    var dayContainer = document
                                                        .querySelector('.easepick-wrapper')
                                                        .shadowRoot.querySelector("div[data-time='".concat(jsDate.getTime(), "']"));
                                                    var span = dayContainer.querySelector('.day-price') || document.createElement('span');
