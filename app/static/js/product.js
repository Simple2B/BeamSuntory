    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                compressedImageFile = new File([compressedImage], initialImage.name, {
