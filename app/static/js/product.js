...
viewProductButtonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        ...
        var mstrGroups = Object.keys(product.mstr_groups_groups);
        mstrGroups.forEach(function (groupName) {
            var isEqual = false;
            if (product.current_user_groups.hasOwnProperty(groupName)) {
                var currentUserValue = product.current_user_groups[groupName];
                var mstrGroupsValue = product.mstr_groups_groups[groupName];
                if (currentUserValue.includes(mstrGroupsValue)) {
                    isEqual = true;
                }
            }
            addShipAssignShareButton(isEqual, groupName, product.mstr_groups_groups[groupName], product);
        });
...
function assign(product) {
    var div = document.querySelector('#product-assign-name');
    div.innerHTML = product.name;
...
function deleteShipAssignButton(nameGroup, nameGroupValue) {
    var shipAssignShareContainer = document.querySelector("#product-ship-assign-share-container-".concat(nameGroup));
    var groupContainer = document.querySelector("#product-view-product_group-container-".concat(nameGroupValue));
...
function addShipAssignShareButton(isEqual, masterGroup, group, productParam) {
    ...
    shipAssignContainer.setAttribute('id', "product-ship-assign-share-container-".concat(masterGroup));
    ...
    shareContainer.setAttribute('id', "product-ship-assign-share-container-".concat(masterGroup));
...
productFilterInputs.forEach(function (input) {
    input.addEventListener('change', function () {
        ...
        var filterInputId = filterInputDataTarget
            .split(',')[0]
        ...
        if (filterInputIdString.includes(filterButtonId)) {
            ...
            var filterJsonDataStorage_1 = sessionStorage.getItem('filterJsonData');
            var filterDataObject = JSON.parse(filterJsonDataStorage_1);
            delete filterDataObject[filterButtonId];
            var newFilterJsonData_1 = JSON.stringify(filterDataObject);
            sessionStorage.setItem('filterJsonData', newFilterJsonData_1);
        ...
        var filterJsonDataStorage = sessionStorage.getItem('filterJsonData');
        var filterJsonDataObject = JSON.parse(filterJsonDataStorage);
        var newFilterData = __assign(__assign({}, filterJsonDataObject), filterJsonData);
        var newFilterJsonData = JSON.stringify(newFilterData);
...
filterProductButton.addEventListener('click', function (e) {
    ...
    var filterJsonDataSessionStorage = JSON.stringify(filterJsonData);
