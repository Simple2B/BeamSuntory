...
var modalOptions = {
    ...
    onHide: function () {
        ...
        var mstrGroups = Object.keys(product.current_user_groups);
        mstrGroups.forEach(function (e) {
...
var requestShareModal = new flowbite_1.Modal($requestShareModalElement, modalOptions);
var shipModal = new flowbite_1.Modal($shipModalElement, modalOptions);
var assignModal = new flowbite_1.Modal($assignModalElement, modalOptions);
...
function editProduct(product) {
    ...
    mstrGroups.forEach(function (groupName) {
        var isEqualGroup = product.mstr_groups_groups.hasOwnProperty(groupName);
...
function deleteShipAssignButton(nameGroup) {
...
function addShipAssignShareButton(isEqual, modal, masterGroup) {
    var productTypeContainer = document.querySelector("#product-".concat(modal, "-product_type-container-").concat(masterGroup));
