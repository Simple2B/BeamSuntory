    ...
    if (isVisibleFilter) {
        ...
        productItemTrs.forEach(function (product) {
            ...
            for (var key in filterData) {
                ...
                productFilterTd.classList.add('p-4', 'text-base', 'font-normal', 'text-gray-900', 'whitespace-nowrap', 'dark:text-white', 'max-width-100');
