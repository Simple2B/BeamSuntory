...
function adjustProduct(productParam, csrfToken) {
    return __awaiter(this, void 0, void 0, function () {
        var adjustGroups, adjustGroupsQty, adjustNote, groupsQty, i, adjustGroup, adjustGroupQty, groupQty, data, base_url, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    adjustGroups = document.querySelectorAll('.product-adjust-group');
                    adjustGroupsQty = document.querySelectorAll('.product-adjust-group-quantity');
                    adjustNote = document.querySelector('#product-adjust-note');
                    groupsQty = [];
                    for (i = 0; i < adjustGroups.length; i++) {
                        adjustGroup = adjustGroups[i];
                        adjustGroupQty = adjustGroupsQty[i];
                        console.log('adjustGroup', adjustGroup.value);
                        groupQty = {
                            quantity: Number(adjustGroupQty.value),
                            group_id: adjustGroup.value,
                        };
                    ...
                    data = {
                        ...
                        groups_quantity: JSON.stringify(groupsQty),
