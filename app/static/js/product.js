...
function editProduct(product) {
    ...
    if (productMasterGroups.length > 0) {
        ...
        var _loop_2 = function (i) {
            var productMasterGroupEditSelect = document.querySelector("#product-master-group-edit-item-".concat(i + 1));
            console.log(i);
            var options_1 = productMasterGroupEditSelect.querySelectorAll('option');
            var productGroupsEditSelect = productGroupsEditSelects[i];
            productMasterGroupEditSelect.value = productMasterGroups[i];
            console.log('productGroupsEditSelect', "#product-master-group-edit-item-".concat(i + 1));
            product.mstr_grps_grps_names_in_prod[productMasterGroups[i]].forEach(function (group) {
                var storeSelectOption = document.createElement('option');
                storeSelectOption.setAttribute('value', group.group_id.toString());
                storeSelectOption.textContent = group.group_name;
            ...
            productMasterGroupEditSelect.addEventListener('change', function () {
                options_1.forEach(function (e) {
                    if (e.textContent ===
                        productMasterGroupEditSelect.options[productMasterGroupEditSelect.selectedIndex].text) {
                        var groupSelect_2 = document.querySelector("#product-group-edit-item-".concat(i + 1));
