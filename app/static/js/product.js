...
function getEventAvailableQuantity(product_id, group, calendarFilter) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/event/get_available_quantity?group_name=".concat(group, "&product_id=").concat(product_id, "&dates=").concat(JSON.stringify(calendarFilter)))];
                case 1:
                    response = _a.sent();
