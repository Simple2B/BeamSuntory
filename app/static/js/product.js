    ...
    productMasterGroupEditSelect.addEventListener('change', function () {
        options.forEach(function (e) {
            if (e.textContent === productMasterGroupEditSelect.options[productMasterGroupEditSelect.selectedIndex].text) {
                ...
                var groupSelect_1 = document.querySelector('#product-group-edit-item-1');
...
function createInboundOrderItems(productParam) {
    ...
    productGroupEditItem.classList.add('p-6', 'space-y-6', 'border-t', 'product-group-add-add-item', "delete-id-".concat(productParam.id));
    ...
    var deleteButtons = document.querySelectorAll('.product-group-edit-delete-item-btn');
    deleteButtons.forEach(function (button) {
        return button.addEventListener('click', function () {
            var inboundOrderItem = button.closest('.product-group-edit-add-item');
            if (inboundOrderItem) {
