...
productImageAnchors.forEach(function (e) {
    e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        var productId, response, data, image, productName;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    productId = e.getAttribute('data-target-product-id');
                    return [4 /*yield*/, fetch("/product/full_image/".concat(productId), {
                            method: 'GET',
                        })];
                case 1:
                    response = _a.sent();
