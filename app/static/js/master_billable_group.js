...
var $modalElement = document.querySelector('#editMasterBillableGroupModal');
var addMasterBillableGroupModalElement = document.querySelector('#add-master-billable-group-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal(addMasterBillableGroupModalElement, modalOptions);
var editMasterBillableGroupCloseModalButton = document.querySelector('#edit-master-billable-group-modal-close-btn');
editMasterBillableGroupCloseModalButton.addEventListener('click', function () {
    modal.hide();
});
var $buttonElements = document.querySelectorAll('.master-billable-group-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-master-billable-groups');
var searchInputButton = document.querySelector('#table-search-master-billable-group-button');
...
var deleteButtons = document.querySelectorAll('.delete-master-billable-group-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-master-billable-group-id');
                    return [4 /*yield*/, fetch("/master_billable_group/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editMasterGroup(masterGroupProduct) {
    var input = document.querySelector('#master-billable-group-edit-name');
