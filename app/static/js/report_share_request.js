...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var viewShareRequestStatusHTML = viewModalHTML.querySelector('#view-share-request-status');
    var viewGroupHTML = viewModalHTML.querySelector('#view-group');
    var viewDesiredQuantityHTML = viewModalHTML.querySelector('#view-desired-quantity');
    var viewProductSkuHTML = viewModalHTML.querySelector('#view-product-sku');
    var viewProductNameHTML = viewModalHTML.querySelector('#view-product-name');
    ...
    htmxDispatcher.onLoad('request-shares-table', function () {
        ...
        viewButtons.forEach(function (button) {
            var reportRequestShare = JSON.parse(button.getAttribute('data-target'));
            // view click
...
/*!*************************************!*\
  !*** ./src/report_share_request.ts ***!
  \*************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
var flowbite_1 = __webpack_require__(/*! flowbite */ "./node_modules/flowbite/lib/esm/index.js");
var base_1 = __webpack_require__(/*! ./base */ "./src/base.ts");
base_1.htmxLoader.onLoad('share-request-table', function (target) {
    // init view modal
    var viewModalHTML = document.getElementById('report-request-share-view-modal');
    var viewUserHTML = viewModalHTML.querySelector('#report-request-share-view-user');
    var viewActionHTML = viewModalHTML.querySelector('#report-request-share-view-action');
    var viewCreatedDateHTML = viewModalHTML.querySelector('#report-request-share-view-created-date');
    var viewShareRequestStatusHTML = viewModalHTML.querySelector('#report-request-share-view-share-request-status');
    var viewGroupHTML = viewModalHTML.querySelector('#report-request-share-view-group');
    var viewDesiredQuantityHTML = viewModalHTML.querySelector('#report-request-share-view-desired-quantity');
    var viewProductSkuHTML = viewModalHTML.querySelector('#report-request-share-view-product-sku');
    var viewProductNameHTML = viewModalHTML.querySelector('#report-request-share-view-product-name');
    var viewHistoryHTML = viewModalHTML.querySelector('#report-request-share-view-history');
    var viewModalOptions = {
        placement: 'bottom-right',
        backdrop: 'dynamic',
        backdropClasses: 'bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40',
