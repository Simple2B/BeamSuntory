...
// initialize modal
var viewReportEventsModal = document.getElementById('report-assign-view-modal');
var viewModalOptions = {
    ...
    closable: true,
    onHide: function () {
        var productItems = document.querySelectorAll('.report-assign-product-item-view');
...
var reportViewProductTbody = document.querySelector('#report-assign-table-products');
var productItemTemplate = document.querySelector('#report-assign-view-product-item-template');
...
// DOM
var reportViewUser = document.getElementById('report-assign-user');
var reportViewAction = document.getElementById('report-assign-action');
var reportViewDate = document.getElementById('report-assign-date');
var reportGroupFrom = document.getElementById('report-assign-group-from-view');
var reportGroupTo = document.getElementById('report-assign-group-to-view');
var reportQuantity = document.getElementById("report-assign-quantity-view");
var reportWarehouse = document.getElementById("report-assign-warehouse-view");
base_1.htmxLoader.onLoad('report-assign-table', function (target) {
    ...
    reportViewButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            reportViewDate.innerHTML = (0, utils_1.formatDate)(reportAssign.createdAt);
            ...
            reportWarehouse.innerHTML = reportAssign.product.warehouseProducts.map(function (warehouseProduct) { return warehouseProduct.warehouse.name; }).filter(function (value, index, array) { return array.indexOf(value) === index; }).join(', ');
            var newProductItem = productItemTemplate;
            newProductItem.removeAttribute('id');
            newProductItem.classList.remove('hidden');
            newProductItem.classList.add('report-assign-product-item-view', 'text-base', 'font-semibold', 'text-gray-900', 'dark:text-white');
