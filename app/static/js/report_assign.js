...
var downloadCSV = function () {
    return __awaiter(this, void 0, void 0, function () {
        var searchInput, filterFromGroup, filterToGroup, filterBrand, filterCategory, filterLanguage, filterPremises, filterDateStartInput, filterDateEndInput, filterUsernameInput, filtersMap, filterQuery, _i, _a, _b, queryKey, queryInput, csvData, pages, queryTail, page, currentURL, url_1, res, data, blob, url, a;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    searchInput = document.querySelector('#table-search-assign');
                    filterFromGroup = document.querySelector('#report-assigns-group-from');
                    filterToGroup = document.querySelector('#report-assigns-group-to');
                    filterBrand = document.querySelector('#report-assigns-brand');
                    filterCategory = document.querySelector('#report-assigns-category');
                    filterLanguage = document.querySelector('#report-assigns-language');
                    ...
                    filterUsernameInput = document.querySelector('#report-assigns-filter-user');
                    filtersMap = {
                        q: searchInput,
                ...
                case 3:
                    data = _c.sent();
                    data.report_events.forEach(function (report) {
                        csvData.push([
...
document.addEventListener('DOMContentLoaded', function () {
    var filtersHTML = document.querySelectorAll("[name='q'], [name='start_date'], [name='end_date'], [name='username'], [name='language'], [name='category'], [name='premises'], [name='from_group'], [name='to_group'], [name='brand']");
    ...
    var closingViewModalButton = document.querySelector('#button-closing-report-assign-modal');
    ...
    htmxDispatcher.onLoad('events-table', function (target) {
        ...
        reportViewButtons.forEach(function (btn) {
            btn.addEventListener('click', function () {
                var _a;
                var reportAssign = JSON.parse(btn.getAttribute('data-target'));
                ...
                var productSku = document.querySelector('.product-sku');
                var productGroup = document.querySelector('.product-group');
                var productGroupFrom = document.querySelector('.product-group-from');
                var productQuantity = document.querySelector('.product-quantity');
                var productSupplierName = document.querySelector('.supplier-name');
                var productSupplierAddress = document.querySelector('.supplier-address');
                var productSupplierPhone = document.querySelector('.supplier-number');
                var productWarehouse = document.querySelector('.product-warehouse');
                var img = document.querySelector('.product-image');
                reportAssign.product.image.length > 100
                    ? (img.src = "data:image/png;base64, ".concat(reportAssign.product.image))
                ...
                productSupplierPhone.innerHTML = (_a = reportAssign.product.supplier.contact_number) !== null && _a !== void 0 ? _a : '-';
                var warehousesAmount = reportAssign.product.warehouses.length;
                var warehouses = reportAssign.product.warehouses.reduce(function (acc, warehouseProduct, index) {
                    acc += warehouseProduct.name;
                    if (index < warehousesAmount - 1)
                        acc += ', ';
                    return acc;
                }, '');
