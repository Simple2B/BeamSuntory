...
var $modalElement = document.querySelector('#editStoreCategoryModal');
var $addStoreCategoryModalElement = document.querySelector('#add-store-category-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addStoreCategoryModalElement, modalOptions);
var $buttonElements = document.querySelectorAll('.store-category-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-store-categories');
var searchInputButton = document.querySelector('#table-search-store-category-button');
...
var deleteButtons = document.querySelectorAll('.delete-store-category-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-store-category-id');
                    return [4 /*yield*/, fetch("/store_category/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
var defaultCategoryImage = 'https://github.com/Simple2B/BeamSuntory/blob/develop/app/static/img/logo-mini.png?raw=true';
function editStoreCategory(storeCategory) {
    var img = document.querySelector('#store-category-edit-image');
    storeCategory.image.length > 100
        ? (img.src = "data:image/png;base64, ".concat(storeCategory.image))
        : (img.src = defaultCategoryImage);
    var input = document.querySelector('#store-category-edit-name');
