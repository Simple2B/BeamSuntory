...
var $modalElement = document.querySelector('#edit-sub-group-modal');
var modalOptions = {
...
var closingEditModalButton = document.getElementById('edit-stock-target-group-modal-close-btn');
closingEditModalButton.addEventListener('click', function () {
    modal.hide();
});
var $buttonElements = document.querySelectorAll('.group-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-groups');
var searchInputButton = document.querySelector('#table-search-group-button');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-group-id');
                    return [4 /*yield*/, fetch("/sub_stock_target_group/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editGroup(group) {
    var input = document.querySelector('#sub-group-edit');
