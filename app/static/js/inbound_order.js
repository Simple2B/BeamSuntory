...
var addModal = new flowbite_1.Modal($addInboundOrderModalElement, modalOptions);
...
function editInboundOrder(inboundOrder) {
    var input = document.querySelector('#inbound-order-edit-order_id');
