...
var $modalElement = document.querySelector('#editGroupModal');
var $addGroupModalElement = document.querySelector('#add-group-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addGroupModalElement, modalOptions);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/group/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editGroup(group) {
    var input = document.querySelector('#group-edit-name');
