...
var viewModalClosingButton = document.querySelector('#buttonClosingViewPickupOrderModal');
viewModalClosingButton.addEventListener('click', function () {
    viewModal.hide();
});
var editModalClosingButton = document.querySelector('#buttonClosingEditPickupOrderModal');
