...
(function (OrderStatus) {
    OrderStatus["assigned"] = "Assigned to pickup";
    OrderStatus["inTransit"] = "In transit";
    OrderStatus["delivered"] = "Delivered";
    OrderStatus["cancelled"] = "Cancelled";
    OrderStatus["waitingForWarehouse"] = "Waiting for warehouse manager";
})(OrderStatus || (OrderStatus = {}));
var $modalViewElement = document.querySelector('#view-pickup-order-modal');
var $modalEditElement = document.querySelector('#edit-pickup-order-modal');
var modalViewOptions = {
    ...
    onHide: function () {
        ...
        var tableShipRequestBody = document.querySelector('#table-pickup-order-body-view');
        while (tableShipRequestBody.firstChild) {
            tableShipRequestBody.removeChild(tableShipRequestBody.firstChild);
        }
        var orderActionsButtons = document.querySelectorAll('.pickup-order-actions-btn');
        orderActionsButtons.forEach(function (btn) {
...
var modalEditOptions = {
    ...
    onHide: function () {
        console.log('modal is hidden');
        var tableShipRequestBody = document.querySelector('#table-pickup-order-body-edit');
        while (tableShipRequestBody.firstChild) {
            tableShipRequestBody.removeChild(tableShipRequestBody.firstChild);
        }
    },
...
// ----view modal-----
var viewPickupOrderButtonElements = document.querySelectorAll('.pickup-order-view-button');
viewPickupOrderButtonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        ...
        var div = document.querySelector('#pickup-order-view-order-number');
        ...
        var input = document.querySelector('#pickup-order-edit-id');
        ...
        switch (shipRequest.status) {
            case OrderStatus.assigned:
                var pickupOrderButton = document.querySelector('.pickup-order-view-pickup-order-btn');
                pickupOrderButton.classList.remove('hidden');
                pickupOrderButton.classList.add('inline-flex');
                break;
            case OrderStatus.inTransit:
                console.log('in transit');
                var deliverButton = document.querySelector('.pickup-order-view-confirm-delivery-btn');
...
// -----edit modal------
var $buttonEditElements = document.querySelectorAll('.pickup-order-edit-button');
...
function editShipRequest(shipRequest, store) {
    var input = document.querySelector('#pickup-order-edit-status');
    ...
    var div = document.querySelector('#pickup-order-edit-order-number');
    div.innerHTML = shipRequest.orderNumb;
...
function createPickupOrderItemTable(shipRequest, typeModal) {
    var tableShipRequestBody = document.querySelector("#table-pickup-order-body-".concat(typeModal));
    shipRequest.carts.forEach(function (cart, index) {
...
// search flow
var searchPickupInput = document.querySelector('#table-search-pickup-order');
...
var updateNotesButtons = document.querySelectorAll('.pickup-order-view-notes-btn');
updateNotesButtons.forEach(function (e) {
    e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        var shipRequestId, daNotes, csrfTokenInput, data, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    shipRequestId = document.querySelector('#pickup-order-edit-id').getAttribute('value');
                    daNotes = document.querySelector('#pickup-order-view-da_notes');
                    ...
                    return [4 /*yield*/, fetch("/pickup_order/update_notes", {
                            method: 'POST',
                            headers: {
...
var deliverButtons = document.querySelectorAll('.pickup-order-view-confirm-delivery-btn');
deliverButtons.forEach(function (e) {
    e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        var shipRequestId, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    shipRequestId = document.querySelector('#pickup-order-edit-id').getAttribute('value');
                    return [4 /*yield*/, fetch("/pickup_order/deliver/".concat(shipRequestId), {
                            method: 'GET',
                        })];
                case 1:
                    response = _a.sent();
