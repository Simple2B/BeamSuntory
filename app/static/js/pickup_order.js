...
function createPickupOrderItemTable(shipRqst, typeModal) {
    ...
    currentCartItems.forEach(function (product, index) {
        ...
        var warehouseNameView = shipRqst.warehouse_name || 'No warehouse';
        ...
        if (typeModal === 'edit') {
            ...
            var selectWarehouse = tableShipRequestItem.querySelector("#pickup-order-".concat(typeModal, "-warehouse-name"));
