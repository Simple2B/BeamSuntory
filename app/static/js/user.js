...
function editUser(user) {
    ...
    var sales_rep = document.querySelector('#user-edit-sales_rep');
    sales_rep.addEventListener('click', function () {
        console.log('click');
    ...
    function selectOption(event) {
        ...
        var joinedOptionsBtn = selectedOptions.join(', ');
...
var lockerAddressContainer = document.querySelector('#user-add-locker-address-container');
