...
var closingEditModalButton = document.querySelector('#edit-current-user-modal-close-btn');
...
var resetPasswordButtons = document.querySelectorAll('.reset-password-user-btn');
resetPasswordButtons.forEach(function (e) {
    e.addEventListener('click', function () {
        return __awaiter(this, void 0, void 0, function () {
            var unique_id, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!confirm('Are sure?')) return [3 /*break*/, 2];
                        unique_id = e.getAttribute('data-user-unique-id');
                        return [4 /*yield*/, fetch("/password_reset/".concat(unique_id), {
                                method: 'GET',
                            })];
                    case 1:
                        response = _a.sent();
...
function editUser(user) {
    var lockerAddressContainer = document.querySelector('#user-edit-locker-address-container');
    var userRole = document.querySelector('#user-edit-role');
    ...
    var userAddDropdownBtn = document.querySelector('#user-edit-dropdown-btn');
    var optionItems = document.querySelectorAll('.user-edit-dropdown-option');
    var selectedOptions = [];
    if (user.group_name) {
        var groupNames = user.group_name.split(', ');
        selectedOptions.push.apply(selectedOptions, groupNames);
    }
    var options = document.querySelector('#user-edit-dropdown-options');
    ...
    optionItems.forEach(function (optionItem) {
        optionItem.addEventListener('click', function (event) {
            ...
            var input = document.getElementById('user-edit-group');
            ...
            var joinedOptions = selectedOptions.join(', ');
    ...
    var div = document.querySelector('#user-edit-dropdown-btn');
...
var viewUserButtonElements = document.querySelectorAll('.user-view-button');
viewUserButtonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        var user = JSON.parse(e.getAttribute('data-target'));
        var lockerAddressContainer = document.querySelector('#user-view-locker-address-container');
        console.log(user);
        ...
        user.sales_rep;
        var div = document.querySelector('#user-view-username');
...
// function to select and add group in dropdown list
var userAddDropdownBtn = document.querySelector('#user-add-dropdown-btn');
var optionItems = document.querySelectorAll('.user-add-dropdown-option');
var selectedOptions = [];
var options = document.querySelector('#user-add-dropdown-options');
userAddDropdownBtn.addEventListener('click', function () {
...
optionItems.forEach(function (optionItem) {
    optionItem.addEventListener('click', function (event) {
        var option = event.target;
        var value = option.textContent;
        var input = document.getElementById('user-add-group');
        window.addEventListener('mouseup', function (event) {
            if (event.target !== options && !options.contains(event.target)) {
                options.classList.add('hidden');
            }
