...
function editUser(user) {
    ...
    var officeAddressContainer = document.querySelector('#user-edit-office-address-container');
...
viewUserButtonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        ...
        var officeAddressContainer = document.querySelector('#user-view-office-address-container');
        if (user.sales_rep) {
...
var officeAddressContainer = document.querySelector('#user-add-office-address-container');
