...
var viewModal = new flowbite_1.Modal($viewUserModalElement, modalOptions);
...
viewUserButtonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        ...
        console.log(user);
        // viewModal.show()
        var input = document.querySelector('#user-view-username');
        input.value = user.username;
