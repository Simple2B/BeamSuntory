...
/***/ "./src/master_group_for_product.ts":
/*!*****************************************!*\
  !*** ./src/master_group_for_product.ts ***!
  \*****************************************/
...
var $modalElement = document.querySelector('#editMasterGroupProductModal');
var $addMasterGroupModalElement = document.querySelector('#add-master-group-product-modal');
var modalOptions = {
...
var $buttonElements = document.querySelectorAll('.master-group-product-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-master-groups-product');
var searchInputButton = document.querySelector('#table-search-master-group-product-button');
...
var deleteButtons = document.querySelectorAll('.delete-master-group-product-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-master-group-product-id');
                    return [4 /*yield*/, fetch("/master_group_for_product/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editMasterGroup(masterGroupProduct) {
    var input = document.querySelector('#master-group-product-edit-name');
