...
var $modalElement = document.querySelector('#editDeliveryAgentModal');
var $addDeliveryAgentModalElement = document.querySelector('#add-delivery-agent-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addDeliveryAgentModalElement, modalOptions);
var editDeliveryAgentCloseModalButton = document.querySelector('#edit-delivery-agent-modal-close-btn');
editDeliveryAgentCloseModalButton.addEventListener('click', function () {
    modal.hide();
});
var $buttonElements = document.querySelectorAll('.delivery-agent-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-delivery-agents');
var searchInputButton = document.querySelector('#table-search-delivery-agent-button');
...
var deleteButtons = document.querySelectorAll('.delete-delivery-agent-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-delivery-agent-id');
                    return [4 /*yield*/, fetch("/delivery_agent/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editDeliveryAgent(deliveryAgent) {
    var input = document.querySelector('#delivery-agent-edit-username');
