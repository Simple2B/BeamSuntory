      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var downloadCSV = function () {
          return __awaiter(this, void 0, void 0, function () {
            var searchShelfLifeInput,
              dateShelfLifeCreatedFromInput,
              dateShelfLifeCreatedToInput,
              filtersMap,
              filterQuery,
              _i,
              _a,
        ...
        document.addEventListener('DOMContentLoaded', function () {
          var filtersHTML = document.querySelectorAll(
            "[name='q'], [name='username'], [name='created_from'], [name='created_to'], [name='master_group'], [name='group'], [name='group_brand'],  [name='group_categories'], [name='group_language'], [name='group_premises'], [name='expire_in']"
          );
