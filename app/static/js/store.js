...
var $modalElement = document.querySelector('#editStoreModal');
var $addStoreModalElement = document.querySelector('#add-store-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addStoreModalElement, modalOptions);
var $buttonElements = document.querySelectorAll('.store-edit-button');
$buttonElements.forEach(function (e) {
    return e.addEventListener('click', function () {
        editStore(JSON.parse(e.getAttribute('data-target')));
    });
});
var closingEditModalButton = document.querySelector('#edit-store-modal-close-btn');
closingEditModalButton.addEventListener('click', function () {
    modal.hide();
});
// search flow
var searchInput = document.querySelector('#table-search-stores');
var searchInputButton = document.querySelector('#table-search-store-button');
...
var deleteButtons = document.querySelectorAll('.delete-store-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-store-id');
                    console.log('id: ', id);
                    return [4 /*yield*/, fetch("/store/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editStore(store) {
    var input = document.querySelector('#store-edit-store_name');
...
var addFavoriteCheckboxes = document.querySelectorAll('.store-add-favorite-btn');
addFavoriteCheckboxes.forEach(function (checkbox, index) {
    checkbox.addEventListener('change', function () { return __awaiter(void 0, void 0, void 0, function () {
        var favoriteContainer, imageStar, storeId, userId, favStore, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    favoriteContainer = checkbox.closest('.favorite-container');
                    imageStar = favoriteContainer.querySelector('.store-add-favorite-star');
                    storeId = checkbox.getAttribute('data-store-id');
                    userId = checkbox.getAttribute('data-user-id');
                    favStore = {
                        store_id: storeId,
                        user_id: userId,
                    };
                    return [4 /*yield*/, fetch('/store/add-favorite', {
                            method: 'POST',
                            headers: {
...
var favoriteAllStoresBtn = document.querySelector('#store-show-favorite-all-btn');
favoriteAllStoresBtn.addEventListener('change', function () {
    var favoriteCheckboxes = document.querySelectorAll('.store-add-favorite-btn');
    if (favoriteAllStoresBtn.checked) {
        favoriteCheckboxes.forEach(function (checkbox) {
            var storeItem = checkbox.closest('.table-store-item-tr');
            if (checkbox.checked) {
