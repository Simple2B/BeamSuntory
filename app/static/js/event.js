...
var $modalEditElement = document.querySelector('#event-edit-modal');
var editModal = new flowbite_1.Modal($modalEditElement, modalEditOptions);
var editModalCloseButton = document.querySelector('#edit-event-modal-close-btn');
editModalCloseButton.addEventListener('click', function () {
    editModal.hide();
});
var editModalButtons = document.querySelectorAll('#event-edit-button');
editModalButtons.forEach(function (e) {
    return e.addEventListener('click', function () {
        var eventData = JSON.parse(e.getAttribute('data-target'));
        var reservedDaysAmountBefore = document.querySelector('#event-edit-reserve-date-to-before');
        var eventId = document.querySelector('#event-edit-id');
        reservedDaysAmountBefore.innerHTML = (0, utils_1.formatDate)(eventData.dateReserveTo);
