...
// search flow
var searchShareInput = document.querySelector('#table-search-request-share');
var searchShareInputButton = document.querySelector('#table-search-request-share-button');
if (searchShareInputButton && searchShareInput) {
    searchShareInputButton.addEventListener('click', function () {
        var url = new URL(window.location.href);
        url.searchParams.set('q', searchShareInput.value);
        window.location.href = "".concat(url.href);
    });
}
var shareButtons = document.querySelectorAll('.request-share-share-button');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-request-share-id');
                    return [4 /*yield*/, fetch("/request_share/share/".concat(id), {
                            method: 'GET',
                        })];
                case 1:
                    response = _a.sent();
...
var removeButtons = document.querySelectorAll('.delete-request-share-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!confirm('Are sure?')) return [3 /*break*/, 2];
                    id = e.getAttribute('data-request-share-id');
                    return [4 /*yield*/, fetch("/request_share/delete/".concat(id), {
                            method: 'GET',
                        })];
                case 1:
                    response = _a.sent();
...
var declineButtons = document.querySelectorAll('.decline-request-share-btn');
declineButtons.forEach(function (e) {
    e.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
        var id, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!confirm('Are sure?')) return [3 /*break*/, 2];
                    id = e.getAttribute('data-request-share-id');
                    return [4 /*yield*/, fetch("/request_share/decline/".concat(id), {
                            method: 'GET',
                        })];
                case 1:
                    response = _a.sent();
...
var $buttonEditElements = document.querySelectorAll('.request-share-edit-button');
...
var $modalEditElement = document.querySelector('#editRequestShareModal');
var editModal = new flowbite_1.Modal($modalEditElement, modalEditOptions);
function editShareRequest(requestShare) {
    var input = document.querySelector('#request-share-edit-quantity');
    ...
    var div = document.querySelector('#request-share-edit-status');
