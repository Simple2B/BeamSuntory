...
var downloadCSV = function () {
    return __awaiter(this, void 0, void 0, function () {
        var searchEventInput, dateEventStartFromInput, dateEventStartToInput, dateEventEndFromInput, dateEventEndToInput, usernameEventInput, filtersMap, filterQuery, _i, _a, _b, queryKey, queryInput, csvData, pages, queryTail, page, currentURL, url_1, res, data, blob, url, a;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    usernameEventInput = document.querySelector('#product-event-filter-user');
                    filtersMap = {
                        q: searchEventInput,
                    ...
                    csvData = ['created_at,store_name,type,username,date_from,date_to,sku,product_name'];
                    pages = 1;
                ...
                case 1:
                    ...
                    currentURL = window.location.href.replace(/#/g, '').replace(/#/g, '').replace(/#/g, '');
...
document.addEventListener('DOMContentLoaded', function () {
    var filtersHTML = document.querySelectorAll("[name='q'], [name='username'], [name='sort-start-from'], [name='sort-start-to'], [name='sort-end-from'], [name='sort-end-from']");
    var buttonLoadEventsTable = document.querySelector('#table-report-loader');
    var tableRow = document.querySelectorAll('.table-event-item-tr');
    tableRow.forEach(function (row) {
        var viewReportEventsModal = row.querySelector('.report-event-view-btn');
        var data = JSON.parse(viewReportEventsModal.getAttribute('data-target'));
        var reportStore = data.shipRequest.store.storeName;
        var reportEventStoreDiv = row.querySelector('.report-event-store');
