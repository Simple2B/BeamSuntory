                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, fetch("".concat(location.href, "/").concat(url_1))];
                                case 1:
                                    res = _d.sent();
                                ...
                                case 2:
                                    data = _d.sent();
                                    console.log(data);
                                    data.report_events[0].events.forEach(function (event) {
                                        csvData.push([
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var reportViewHistory = document.getElementById('report-event-history');
    ...
    reportViewButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            reportEvent.events.forEach(function (event, i) {
                // Render event
                ...
                event.product.image.length > 100 ? (img.src = "data:image/png;base64, ".concat(event.product.image)) : (img.src = defaultBrandImage);
