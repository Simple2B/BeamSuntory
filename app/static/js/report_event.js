...
var downloadCSV = function () {
    return __awaiter(this, void 0, void 0, function () {
        var searchEventInput, dateEventStartFromInput, dateEventStartToInput, dateEventEndFromInput, dateEventEndToInput, filtersMap, filterQuery, _i, _a, _b, queryKey, queryInput, csvData, pages, queryTail, _loop_1, page, blob, url, a;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    csvData = ['created_at,history,type,username,date_from,date_to,sku,product_name'];
                    pages = 1;
                    queryTail = '';
                    _loop_1 = function (page) {
                        var currentURL, urlWithoutQueryParams, url_1, res, data, reportEvents;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 2:
                                    data = _d.sent();
                                    reportEvents = data.report_events[0];
                                    reportEvents.ship_request.carts.forEach(function (event) {
                                        csvData.push([
                    ...
                    _c.label = 1;
                case 1:
                    if (!(page <= pages)) return [3 /*break*/, 4];
...
function getFilterValues() {
    ...
    var usernameSelect = document.querySelector('#events-filter-status');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    tableRow.forEach(function (row) {
        ...
        var reportStore = data.ship_request.store.storeName;
        var reportEventStoreDiv = row.querySelector('.report-event-store');
        reportEventStoreDiv.innerHTML = reportStore;
    });
    var eventFilterButton = document.querySelector('#event-filter-button');
    eventFilterButton.addEventListener('click', function () {
        getFilterValues();
    });
    ...
    var reportViewProductTbody = document.getElementById('table-products');
    var productItemTemplate = document.getElementById('view-product-item-template');
    reportViewButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            reportEvent.ship_request.carts.forEach(function (event, i) {
                // Render event
