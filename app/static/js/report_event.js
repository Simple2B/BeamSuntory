    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    data = _c.sent();
                    data.report_events.forEach(function (reportEvent) {
                        reportEvent.shipRequest.carts.forEach(function (cart) {
                            csvData.push([
...
// initialize modal
var viewReportEventsModal = document.getElementById('view-report-events-modal');
...
var viewReportEventsModalCloseButton = document.querySelector('#buttonClosingReportEventModal');
viewReportEventsModalCloseButton.addEventListener('click', function () {
    viewModal.hide();
});
// DOM
var reportViewUser = document.getElementById('report-event-user');
var reportViewAction = document.getElementById('report-event-action');
var reportViewDate = document.getElementById('report-event-date');
var reportStoreName = document.getElementById('report-event-store-name');
var productItemTemplate = document.querySelector('#report-event-view-product-item-template');
var reportViewProductTbody = document.querySelector('#report-event-table-products');
base_1.htmxLoader.onLoad('events-table', function (target) {
    var reportViewButtons = target.querySelectorAll('.report-event-view-btn');
    reportViewButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            console.log('click');
            var reportEvent = JSON.parse(btn.getAttribute('data-target'));
            var createAt = new Date(reportEvent.createdAt);
            ...
            reportViewDate.innerHTML = "".concat(month, "/").concat(day, "/").concat(year, " ").concat(hours, ":").concat(minutes);
            reportStoreName.innerHTML = reportEvent.shipRequest.store.storeName;
            reportViewUser.innerHTML = reportEvent.user.username;
            reportViewAction.innerHTML = reportEvent.type;
            reportViewDate.innerHTML = "".concat(month, "/").concat(day, "/").concat(year, " ").concat(hours, ":").concat(minutes);
            reportEvent.shipRequest.carts.forEach(function (event, i) {
                // Render event
                ...
                event.product.image.length > 100
                    ? (img.src = "data:image/png;base64, ".concat(event.product.image))
