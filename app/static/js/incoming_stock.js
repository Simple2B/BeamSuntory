    ...
    if (Object.keys(inboundOrder.inbound_order_prods).length > 0) {
        ...
        if (currentInboundOrder) {
            for (var i_1 = 0; i_1 < currentInboundOrder.length; i_1++) {
                createEditInboundOrderItems(currentInboundOrder[i_1]);
            }
        }
    }
    editModal.show();
}
function createEditInboundOrderItems(curInbOrder) {
...
function viewInboundOrder(inboundOrder) {
    ...
    if (Object.keys(inboundOrder.inbound_order_prods).length > 0) {
        ...
        if (currentInboundOrder) {
            for (var i_3 = 0; i_3 < currentInboundOrder.length; i_3++) {
                createViewInboundOrderItems(inboundOrder, currentInboundOrder[i_3]);
            }
        }
    }
    viewModal.show();
...
function createViewInboundOrderItems(inbOrder, curInbOrder) {
