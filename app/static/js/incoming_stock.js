...
function setProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var incomingStockProducts, incomingStockProductsQuantity, products, i, incomingStockProduct, incomingStockQuantity, productId, product, inputRecievedProducts;
        return __generator(this, function (_a) {
            incomingStockProducts = document.querySelectorAll('.incoming-stock-product-item');
            incomingStockProductsQuantity = document.querySelectorAll('.incoming-stock-edit-recieved-quantity');
            products = [];
            for (i = 0; i < incomingStockProducts.length; i++) {
                incomingStockProduct = incomingStockProducts[i];
                incomingStockQuantity = incomingStockProductsQuantity[i];
                productId = incomingStockProduct.getAttribute('data-target-product-id');
                product = {
            ...
            inputRecievedProducts = document.querySelector('#incoming-stock-edit-recieved-products');
...
inboundOrderSaveProductsButton.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
    var inboundOrder, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, setProducts()];
            case 1:
                _a.sent();
                if (!confirm('Are sure?')) return [3 /*break*/, 3];
                inboundOrder = JSON.parse(sessionStorage.getItem('inboundOrder'));
                return [4 /*yield*/, fetch("/incoming_stock/accept/".concat(inboundOrder.id), {
                        method: 'GET',
                    })];
            case 2:
                response = _a.sent();
