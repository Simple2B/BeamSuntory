...
function getFullImage(id) {
    return __awaiter(this, void 0, void 0, function () {
        var image, response, data, productName, error_1;
...
document.querySelector('#product-upload-save-products-btn').addEventListener('click', function () {
    var _a;
    var uploadGroupInput = document.querySelector('#product-target-group-upload');
    ...
    if (uploadGroupInput.value) {
        groupId = (_a = option.getAttribute('data-group-id')) !== null && _a !== void 0 ? _a : 999999999;
    }
    else {
        groupId = 999999999;
    }
    var hiddenInput = document.getElementById('product-target-group-upload-hidden');
    hiddenInput.value = groupId.toString();
});
var dropdownSidebar = document.querySelectorAll('.dropdown-btn');
dropdownSidebar.forEach(function (btn) {
    var btnElement = btn;
    btnElement.addEventListener('click', function () {
        var dropdownContent = btnElement.nextElementSibling;
        var dropdownArrow = btnElement.lastElementChild;
        var isClose = dropdownContent.classList.contains('dropdown-close');
        btnElement.classList.toggle('bg-red-600');
        dropdownSidebar.forEach(function (otherBtn) {
            var otherBtnElement = otherBtn;
            if (otherBtn !== btn) {
                var otherContent = otherBtnElement.nextElementSibling;
                var otherArrow = otherBtnElement.lastElementChild;
