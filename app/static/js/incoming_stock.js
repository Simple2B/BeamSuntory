...
function createIncomingStockOrderItems(productAllocated) {
    ...
    var totalAllocatedQuantityDiv = productAllocatedContainer.querySelector('.product-incoming-stock-edit-total-quantity');
    ...
    productAllocated.productQuantityGroups.forEach(function (quantityGroup, index) {
        ...
        groupQuantityReceivedInput.classList.add("product-".concat(productAllocated.id, "-group-").concat(quantityGroup.group.id, "-received-quantity"));
        ...
        quantityPerWrapDiv.classList.add("product-".concat(productAllocated.id, "-group-").concat(quantityGroup.group.id, "-per-wrap"));
        ...
        quantityWrapCartonDiv.classList.add("product-".concat(productAllocated.id, "-group-").concat(quantityGroup.group.id, "-wrap-carton"));
        quantityWrapCartonDiv.setAttribute('required', 'true');
        quantityWrapCartonDiv.placeholder = 'Quantity';
        var quantityCartonMasterDiv = productGroupQuantityPackageInfoContainer.querySelector('.quantity-carton-master');
        quantityCartonMasterDiv.classList.add("product-".concat(productAllocated.id, "-group-").concat(quantityGroup.group.id, "-carton-master"));
    ...
    viewIncomingStockButtons.forEach(function (viewButton) {
        return viewButton.addEventListener('click', function () {
            ...
            inboundOrder.productsAllocated.forEach(function (productsAllocated) {
                ...
                productAllocatedContainer.classList.remove('hidden');
                productAllocatedContainer.classList.add('grid');
                var orderProductNamesView = productAllocatedContainer.querySelector('#incoming-stock-view-product-name');
                var orderProductQuantitiesView = productAllocatedContainer.querySelector('#incoming-stock-view-product-quantity');
    ...
    inboundOrderSaveProductsButton.addEventListener('click', function () {
        ...
        inboundOrder.productsAllocated.forEach(function (productAllocated) {
            ...
            productAllocated.productQuantityGroups.forEach(function (productQuantityGroup) {
                var receivedQtyInput = document.querySelector(".product-".concat(productAllocated.id, "-group-").concat(productQuantityGroup.group.id, "-received-quantity"));
                var perWrapInput = document.querySelector(".product-".concat(productAllocated.id, "-group-").concat(productQuantityGroup.group.id, "-per-wrap"));
                var wrapCartonInput = document.querySelector(".product-".concat(productAllocated.id, "-group-").concat(productQuantityGroup.group.id, "-wrap-carton"));
                var cartonMasterInput = document.querySelector(".product-".concat(productAllocated.id, "-group-").concat(productQuantityGroup.group.id, "-carton-master"));
                var packageInfoData = {
