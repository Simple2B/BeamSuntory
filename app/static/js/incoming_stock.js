...
function setProducts() {
    ...
    var products = [];
    for (var i = 0; i < incomingStockProducts.length; i++) {
        var incomingStockProduct = incomingStockProducts[i];
