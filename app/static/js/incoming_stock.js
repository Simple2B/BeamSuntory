...
var i = 0;
var $modalElement = document.querySelector('#editIncomingStockModal');
var modalOptions = {
    ...
    if (Object.keys(inboundOrder.inbound_order_prods).length > 0) {
        ...
        if (currentInboundOrder) {
            for (var i_1 = 0; i_1 < currentInboundOrder.length; i_1++) {
                createInboundOrderItems(currentInboundOrder[i_1]);
            }
        }
    }
    modal.show();
}
function createInboundOrderItems(curInbOrder) {
    ...
    var productImage = incomingStockAddItem.querySelector('.incoming-stock-edit-product-image');
    if (productImage.src.length < 100) {
        ...
        productImage.src = defaultBrandImage_1;
    }
...
viewIncomingStockButtons.forEach(function (e) {
    return e.addEventListener('click', function () {
        ...
        var div = document.querySelector('#incoming-stock-view-quantity-wrap');
...
var orderFilterButton = document.querySelector('#incoming-stock-filter-button');
var orderFilterRadioButtons = document.querySelectorAll('.incoming-stock-filter-radio-button');
var radioButton = document.querySelector('#dropdownRadioButton-incoming-stock-status');
