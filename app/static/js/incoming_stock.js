...
exports.defaultBrandImage = 'https://raw.githubusercontent.com/Simple2B/BeamSuntory/develop/app/static/img/no_picture_default.png';
...
var $spinnerModalElement = document.querySelector('#spinner-modal');
var modalOptions = {
...
var spinnerModal = new flowbite_2.Modal($spinnerModalElement, modalOptions);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    image.setAttribute('src', "data:image/".concat(data.imageType, ";base64, ").concat(data.image));
