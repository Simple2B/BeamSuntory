...
var downloadCSV = function () {
    return __awaiter(this, void 0, void 0, function () {
        var searchEventInput, dateEventStartFromInput, dateEventStartToInput, dateEventEndFromInput, dateEventEndToInput, masterGroupSelect, groupSelect, productGroupBrand, productGroupCategory, productGroupPremises, productGroupLanguage, productGroupEvent, filtersMap, filterQuery, _i, _a, _b, queryKey, queryInput, csvData, pages, queryTail, page, currentURL, urlWithoutQueryParams, url_1, res, data, blob, url, a;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    searchEventInput = document.querySelector('#table-search-adjustment');
                    dateEventStartFromInput = document.querySelector('#product-adjustment-sort-start-from-datepicker');
                    dateEventStartToInput = document.querySelector('#product-adjustment-sort-start-to-datepicker');
                    dateEventEndFromInput = document.querySelector('#product-adjustment-sort-end-from-datepicker');
                    dateEventEndToInput = document.querySelector('#product-adjustment-sort-end-to-datepicker');
                    masterGroupSelect = document.querySelector('#adjustment-filter-master-group');
                    groupSelect = document.querySelector('#adjustment-filter-group');
                    productGroupBrand = document.querySelector('#adjustment-filter-product-master-group-brand"');
                    productGroupCategory = document.querySelector('#adjustment-filter-product-master-group-category');
                    productGroupPremises = document.querySelector('#adjustment-filter-product-master-group-premises');
                    productGroupLanguage = document.querySelector('#adjustment-filter-product-master-group-language');
                    productGroupEvent = document.querySelector('#adjustment-filter-product-master-group-event');
                    filtersMap = {
                        q: searchEventInput,
                ...
                case 3:
                    data = _c.sent();
                    data.adjusts.forEach(function (adjust) {
...
document.addEventListener('DOMContentLoaded', function () {
    var filtersHTML = document.querySelectorAll("[name='q'], [name='username'], [name='sort-start-from'], [name='sort-start-to'], [name='sort-end-from'], [name='sort-end-to'], [name='master_group'], [name='group'], [name='group_brand'], [name='group_category'], [name='group_premises'], [name='group_language'], [name='group_event']");
    var buttonLoadEventsTable = document.querySelector('#table-report-loader');
    var tableRow = document.querySelectorAll('.table-adjustment-item-tr');
    tableRow.forEach(function (row) {
        var viewReportEventsModal = row.querySelector('.report-adjustment-view-btn');
        var data = JSON.parse(viewReportEventsModal.getAttribute('data-target'));
        var reportStore = data.shipRequest.store.storeName;
        var reportEventStoreDiv = row.querySelector('.report-adjustment-store');
        reportEventStoreDiv.innerHTML = reportStore;
    });
    var clearFilterButton = document.querySelector('#product-adjustment-clear-button');
    ...
    // load table
    buttonLoadEventsTable.click();
    var masterGroupHidden = document.querySelector('#adjustment-master-group-hidden');
    ...
    htmxDispatcher.onLoad('adjustment-table', function (target) {
        ...
        reportViewButtons.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                var createAt = new Date(reportAdjust.createdAt);
                ...
                reportAdjust.adjustGroupQty.forEach(function (adjust, i) {
                    ...
                    newAdjustItem.classList.add('product-item-view', 'text-base', 'font-semibold', 'text-gray-900', 'dark:text-white');
