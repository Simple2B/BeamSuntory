...
var downloadCSV = function () {
    return __awaiter(this, void 0, void 0, function () {
        var filterParamsInput, filterParams, filterQuery, _i, _a, _b, queryKey, queryValue, csvData, pages, queryTail, page, currentURL, urlWithoutQueryParams, url_1, res, data, blob, url, a;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    filterParamsInput = document.querySelector('#adjustment-filter-params-input');
                    filterParams = JSON.parse(filterParamsInput.value);
                    filterQuery = [];
                    for (_i = 0, _a = Object.entries(filterParams); _i < _a.length; _i++) {
                        _b = _a[_i], queryKey = _b[0], queryValue = _b[1];
                        if (queryValue) {
                            filterQuery.push("".concat(queryKey, "=").concat(queryValue));
                        }
                    }
