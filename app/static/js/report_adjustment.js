...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var reportViewAction = document.getElementById('report-adjustment-action');
    ...
    htmxDispatcher.onLoad('adjustment-table', function (target) {
        ...
        reportViewButtons.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                reportViewAction.innerHTML = reportAdjust.type;
                reportViewDate.innerHTML = "".concat(month, "/").concat(day, "/").concat(year, " ").concat(hours, ":").concat(minutes);
                reportAdjust.shipRequest.carts.forEach(function (event, i) {
                    // Render event
