...
var $modalElement = document.querySelector('#editGroupProductModal');
var $addGroupProductModalElement = document.querySelector('#add-group-product-modal');
var modalOptions = {
...
var addModal = new flowbite_1.Modal($addGroupProductModalElement, modalOptions);
var $buttonElements = document.querySelectorAll('.group-product-edit-button');
...
// search flow
var searchInput = document.querySelector('#table-search-groups-product');
var searchInputButton = document.querySelector('#table-search-group-product-button');
...
var deleteButtons = document.querySelectorAll('.delete-group-product-btn');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = e.getAttribute('data-group-product-id');
                    return [4 /*yield*/, fetch("/group_for_product/delete/".concat(id), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
...
function editGroupProduct(groupProduct) {
    var input = document.querySelector('#group-product-edit-name');
