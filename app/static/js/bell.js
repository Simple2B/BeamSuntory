            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    fetch(''.concat(baseURL, '/user/notification'), {
                      method: 'GET',
                    }),
                  ];
                case 1:
        ...
        function limitNotification() {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  return [4 /*yield*/, getNotification()];
                case 1:
                  _a.sent();
