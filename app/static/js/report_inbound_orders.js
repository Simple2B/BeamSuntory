...
var downloadCSV = function () {
    return __awaiter(this, void 0, void 0, function () {
        var searchInput, filterBrand, filterCategory, filterPremises, filterDateStartInput, filterDateEndInput, filtersMap, filterQuery, _i, _a, _b, queryKey, queryInput, csvData, pages, queryTail, page, currentURL, url_1, res, data, blob, url, a;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    searchInput = document.querySelector('#table-search-assign');
                    filterBrand = document.querySelector('#report-assigns-brand');
                    filterCategory = document.querySelector('#report-assigns-category');
                    filterPremises = document.querySelector('#report-assigns-premises');
                    filterDateStartInput = document.querySelector('#report-assigns-start-date');
                    filterDateEndInput = document.querySelector('#report-assigns-end-date');
                    filtersMap = {
                        q: searchInput,
                        brand: filterBrand,
                ...
                case 3:
                    data = _c.sent();
                    data.report_inbound_orders.forEach(function (report) {
                        csvData.push([
...
var formatDate = function (date) {
    ...
    var month = String(createAt.getMonth() + 1).padStart(2, '0');
