        ...
        btn.addEventListener('click', function () {
            ...
            productList.forEach(function (productOrder, i) {
                ...
                if (productOrder.productQuantityGroups.length > 0) {
                    var groups = productOrder.productQuantityGroups.reduce(function (acc, group) {
