...
def save():
    ...
    for product_data in products:
        ...
        if cart.quantity > warehouse_product.product_quantity:
            ...
            flash(
                f"Not enough product in <br>Warehouse:[{warehouse_product.warehouse_name} {warehouse_product.group_name}] qty:[{warehouse_product.product_quantity}]<br>Product:[{cart.product.SKU}]: qty:[{cart.quantity}]",
                "danger",
            )
            return redirect(url_for("outgoing_stock.get_all"))
