...
from wtforms import StringField, SubmitField, ValidationError, FloatField, SelectField
...
#     name = StringField("Name", [DataRequired()])
#     master_billable_group = StringField("Master Billable Group", [DataRequired()])
