...
Revision ID: 236f3a15a64e
Revises: 
Create Date: 2023-09-11 14:43:09.891703
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['cart_id'], ['carts.id'], name=op.f('fk_events_cart_id_carts')),
