...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_report_events_user_id_users')),
    ...
    with op.batch_alter_table('events', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_events_report_id_report_events'), 'report_events', ['report_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('events', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(batch_op.f('fk_events_report_id_report_events'), type_='foreignkey')
