...
Create Date: 2023-06-23 12:44:38.515114
...
def upgrade():
    ...
    sa.Column('quontity', sa.Integer(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=64), nullable=False),
    sa.Column('product_type', sa.Enum('SIMPLE_PRODUCT', 'VARIABLE_PRODUCT', name='producttype'), nullable=False),
    ...
    sa.Column('stock_status', sa.Enum('IN_STOCK', 'LOW_STOCK', 'OUT_OF_STOCK', name='stockstatus'), nullable=False),
    sa.Column('shelf_life', sa.DateTime(), nullable=False),
    sa.Column('program_year', sa.Integer(), nullable=False),
    sa.Column('premises', sa.Enum('ON_PREMISE', 'OFF_PREMISE', name='premises'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['brand_id'], ['str_values.id'], name=op.f('fk_products_brand_id_str_values')),
    sa.ForeignKeyConstraint(['category_id'], ['product_categories.id'], name=op.f('fk_products_category_id_product_categories')),
    sa.ForeignKeyConstraint(['language_id'], ['str_values.id'], name=op.f('fk_products_language_id_str_values')),
    sa.ForeignKeyConstraint(['sub_brand_id'], ['str_values.id'], name=op.f('fk_products_sub_brand_id_str_values')),
    ...
    sa.ForeignKeyConstraint(['country_id'], ['str_values.id'], name=op.f('fk_stores_country_id_str_values')),
    sa.ForeignKeyConstraint(['region_id'], ['str_values.id'], name=op.f('fk_stores_region_id_str_values')),
    ...
    sa.Column('country_id', sa.Integer(), nullable=False),
    sa.Column('region_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['country_id'], ['str_values.id'], name=op.f('fk_suppliers_country_id_str_values')),
    sa.ForeignKeyConstraint(['region_id'], ['str_values.id'], name=op.f('fk_suppliers_region_id_str_values')),
    ...
    sa.Column('country_id', sa.Integer(), nullable=False),
    sa.Column('region_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['country_id'], ['str_values.id'], name=op.f('fk_warehouses_country_id_str_values')),
    sa.ForeignKeyConstraint(['manager_id'], ['users.id'], name=op.f('fk_warehouses_manager_id_users')),
    sa.ForeignKeyConstraint(['region_id'], ['str_values.id'], name=op.f('fk_warehouses_region_id_str_values')),
    ...
    sa.ForeignKeyConstraint(['delivery_agent_id'], ['delivery_agents.id'], name=op.f('fk_inbound_orders_delivery_agent_id_delivery_agents')),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], name=op.f('fk_inbound_orders_product_id_products')),
    ...
    sa.ForeignKeyConstraint(['store_id'], ['stores.id'], name=op.f('fk_ship_requests_store_id_stores')),
    sa.ForeignKeyConstraint(['supplier_id'], ['suppliers.id'], name=op.f('fk_ship_requests_supplier_id_suppliers')),
